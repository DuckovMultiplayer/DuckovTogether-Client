...
namespace EscapeFromDuckovCoopMod
{
    ...
    public static class CoopLocalization
    {
        ...
        private static void LoadChineseFallback()
        {
            ...
            currentTranslations["ui.serverList.empty"] = "暂无在线房间";
            ...
            currentTranslations["ui.button.settings"] = "设置";
            currentTranslations["ui.button.close"] = "关闭";
            currentTranslations["ui.players.title"] = "在线玩家";
            currentTranslations["ui.players.empty"] = "暂无玩家";
            currentTranslations["ui.players.you"] = "(你)";
            ...
            currentTranslations["ui.error.connectionFailed"] = "连接失败";
            currentTranslations["ui.error.timeout"] = "连接超时";
            ...
            currentTranslations["ui.voice.title"] = "语音设置";
            currentTranslations["ui.voice.mute"] = "静音";
            currentTranslations["ui.voice.unmute"] = "取消静音";
            currentTranslations["ui.voice.volume"] = "音量";
            currentTranslations["ui.voice.ptt"] = "按键说话";
            currentTranslations["ui.voice.pttKey"] = "说话键";
            currentTranslations["ui.settings.title"] = "设置";
            currentTranslations["ui.settings.language"] = "语言";
            currentTranslations["ui.settings.graphics"] = "图形";
            currentTranslations["ui.settings.network"] = "网络";
            currentTranslations["ui.relay.selectNode"] = "选择节点";
            currentTranslations["ui.relay.connected"] = "已连接到节点";
            currentTranslations["ui.relay.disconnected"] = "未连接到节点";
            currentTranslations["ui.relay.ping"] = "延迟";
